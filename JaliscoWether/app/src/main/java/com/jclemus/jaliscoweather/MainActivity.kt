package com.jclemus.jaliscoweather
...
import com.jclemus.jaliscoweather.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val appBarConfiguration = AppBarConfiguration(
            setOf(
                R.id.navigation_jalisco, R.id.navigation_zapopan, R.id.navigation_tesistan
            )
        )
        ...
        if (rawReferrer?.isNotBlank() == true) {
            ...
            if (referredValue.size >= 2) {
                val id = when (referredValue[1].toInt()) {
                    0 -> R.id.navigation_jalisco
                    1 -> R.id.navigation_zapopan
                    else -> R.id.navigation_tesistan
                }
